...
(module
    ...
    ;; i32.const (no trampoline-side i32 arg), so the conversion-site codeword
    ;; check is the first decode boundary. Used by the
    ;; `int_conversions_codeword_check_traps_*` tests with
